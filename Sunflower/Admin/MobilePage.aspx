...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary" style="margin-left: 10px; margin-top: 10px; width: 1000px">
        ...
        <div class="panel-body">
            <asp:GridView CssClass="grid-view" RowStyle-CssClass="grid-view-row" ID="gr1" runat="server" Width="100%" HorizontalAlign="Center" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanged="page_changed" OnPageIndexChanging="page_changing" PageSize="10" EditRowStyle-BorderStyle="NotSet" OnSelectedIndexChanged="gr1_SelectedIndexChanged">
                <Columns>
